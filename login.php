                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <button class="btn btn-primary" type="submit" name = "login" href="login.php">Login</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.php">Need an account? Create your account!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
